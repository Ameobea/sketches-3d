...
IncidentLight directLight;
    ...
    computedShadow = all( bvec2( directLight.visible, receiveShadow ) ) ? getShadow( spotShadowMap[ i ], spotLightShadow.shadowMapSize, spotLightShadow.shadowBias, spotLightShadow.shadowRadius, vSpotLightCoord[ i ] ) : 1.0;
    totalShadow *= computedShadow;
		directLight.color *= computedShadow;
		#endif
