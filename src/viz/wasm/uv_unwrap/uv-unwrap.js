...
function findWasmBinary() {
  return locateFile("uv-unwrap.wasm");
}
...
var wasmImports = {
  ...
  /** @export */ I: _fd_write,
  /** @export */ d: invoke_iii,
  /** @export */ s: invoke_iiijjii,
  /** @export */ r: invoke_iijiiiif,
  /** @export */ q: invoke_iijiiiii,
  /** @export */ p: invoke_iijjiiiii,
  /** @export */ h: invoke_vi,
  /** @export */ e: invoke_vii,
  /** @export */ k: invoke_viiij,
  /** @export */ H: _proc_exit
};
...
var ___getTypeName = wasmExports["R"];

var _malloc = wasmExports["T"];

var _free = wasmExports["U"];

var __emscripten_timeout = wasmExports["V"];

var _setThrew = wasmExports["W"];

var __emscripten_stack_restore = wasmExports["X"];

var _emscripten_stack_get_current = wasmExports["Y"];
...
function invoke_iijjiiiii(index, a1, a2, a3, a4, a5, a6, a7, a8) {
  var sp = stackSave();
  try {
...
function invoke_iijiiiif(index, a1, a2, a3, a4, a5, a6, a7) {
  var sp = stackSave();
  try {
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = UVUnwrap;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = UVUnwrap;
