...
const loadTextures = async () => {
  ...
  const cementTextureP = loadTexture(
    loader,
    // 'https://ameo.link/u/amd.png'
    'https://ameo.link/u/amf.png'
  );
