vec3 getCustomEmissive(vec3 pos, vec3 emissive, float curTimeSeconds, SceneCtx ctx) {
  ...
  float noiseVal = ridged_multifractal_noise(noisePos, noiseFreq, noiseLacunarity, noisePersistence, noiseAttenuation);
  ...
  // array of colors
  vec3 colors[5] = vec3[5](vec3(0, 0, 4), vec3(46, 8, 1), vec3(105, 7, 2),
    // vec3(31, 17, 87),
  vec3(73, 2, 2), vec3(43, 2, 2)
    // vec3(65, 32, 129),
    // vec3(18, 57, 73),
    // vec3(33, 49, 136)
  );
